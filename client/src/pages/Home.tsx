...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-secondary/95 to-secondary py-16 md:py-24 flex-grow">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-lg hover:shadow-md transition-all">
              <div className="bg-secondary/10 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6">
                <FaDollarSign className="text-secondary text-3xl" />
              </div>
      ...
      <section className="py-16 bg-neutral-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-4xl mx-auto">
            <div className="relative">
              <div className="bg-white rounded-lg shadow-md p-6 z-10 relative">
                <div className="bg-secondary text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto -mt-10 mb-4 border-4 border-white">
                ...
                <div className="flex justify-center mt-4">
                  <FaSearch className="text-secondary text-3xl" />
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-white rounded-lg shadow-md p-6 z-10 relative">
                ...
                <div className="flex justify-center mt-4">
                  <FaClipboardCheck className="text-secondary text-3xl" />
                </div>
              </div>
              <div className="hidden md:block absolute top-1/2 left-full w-12 h-2 bg-neutral-300 -translate-y-1/2 z-0"></div>
            </div>
            ...
            <div className="relative">
              <div className="bg-white rounded-lg shadow-md p-6 z-10 relative">
                ...
                <div className="flex justify-center mt-4">
                  <FaFileInvoiceDollar className="text-secondary text-3xl" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <Button 
              className="bg-secondary hover:bg-secondary/90 text-white font-semibold py-3 px-6 rounded-md transition-colors text-base flex items-center mx-auto gap-2"
              onClick={() => setLocation('/guia-importacion')}
            >
              Ver Guía Completa
              <FaArrowRight />
      ...
      {/* CTA */}
      <section className="py-16 bg-gradient-to-r from-secondary/90 to-secondary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button 
            className="bg-white text-secondary hover:bg-gray-100 font-semibold py-3 px-8 rounded-md transition-colors text-base inline-flex items-center gap-2"
            onClick={() => setLocation('/busqueda')}
          >
            Comenzar Búsqueda
            <FaSearch />
